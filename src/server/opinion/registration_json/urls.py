...
urlpatterns = patterns('',
		               ...
		               url(r'^facebook/$',
                           views.handle_facebook_login,
			               name='handle_facebook'),
		               url(r'^facebook/register/$',
                           views.handle_facebook_register,
			               name='handle_facebook_r'),
                       url(r'^facebook/registerorlogin/$',
                           views.handle_facebook_register_or_login,
                           name='handle_facebook_rol'),
		               url(r'^twitterurl/$',
                           views.get_twitter_url,
						   name='get_twitter_url'),
						url(r'^twitter/$',
                           views.handle_twitter_login,
						   name='handle_twitter'),
						url(r'^twitter/register/$',
                           views.handle_twitter_register,
						   name='handle_twitter_r'),
                        url(r'^twitter/registerorlogin/$',
                           views.handle_twitter_register_or_login,
                           name='handle_twitter_rol'),
						url(r'^authstate/$',
