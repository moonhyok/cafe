...
def demographics():
	...
	for t in autotexts:
		...
		t.set_color("white")
	ax.set_aspect('equal')
	fig.savefig('/var/www/opinion/opinion.berkeley.edu/landing/m-cafe/ieor170-sp16/src/client/media/images/majors.png')
	...
	for t in autotexts:
		...
		t.set_color("white")
	ax.set_aspect('equal')
	fig.savefig('/var/www/opinion/opinion.berkeley.edu/landing/m-cafe/ieor170-sp16/src/client/media/images/years.png')
	...
	for t in autotexts:
		...
		t.set_color("white")
	ax.set_aspect('equal')
	fig.savefig('/var/www/opinion/opinion.berkeley.edu/landing/m-cafe/ieor170-sp16/src/client/media/images/courses.png')
	...
	for t in autotexts:
		...
		t.set_color("white")
	ax.set_aspect('equal')
	fig.savefig('/var/www/opinion/opinion.berkeley.edu/landing/m-cafe/ieor170-sp16/src/client/media/images/interests.png')
