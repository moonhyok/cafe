...
# For people who did move at least somewhat
...
for user in users:
    ...
    if user_distance_change_pre_sqrt > 0:
        ...
        sum_normalized += user_distance_change_normalized
        count_normalized += 1.0
print 'Mean: %f' % (sum_normalized / count_normalized)
#print num_lines
