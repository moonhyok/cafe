...
# Added for Opinion Space
from registration.views import activate_route
from registration.views import reset_password_route
...
urlpatterns = patterns('',
                       ...
                       # Added for Opinion Space
                       url(r'^activate/route/(?P<activation_key>\w+)/$',
                           activate_route,
                           name='registration_activate_route'),
                       url(r'^password/reset/route/(?P<uidb36>[0-9A-Za-z]+)-(?P<token>.+)/$',
                           reset_password_route,
                           name='registration_reset_password_route'),
                       )
