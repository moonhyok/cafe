...
URL_ROOT = 'http://turing.ieor.berkeley.edu/cde-instances/%NAME%'

DATABASE_ENGINE = 'sqlite3'                     # 'postgresql_psycopg2', 'postgresql', 'mysql', 'sqlite3' or 'oracle'.
DATABASE_NAME = '/var/sqlite/os/%NAME%'    # Or path to database file if using sqlite3.
...
MEDIA_ROOT = '/var/www/opinionspace/instances/%NAME%/src/client/' + MEDIA_DIR_NAME + '/'
...
SESSION_COOKIE_NAME = "%NAME%_cookie"
