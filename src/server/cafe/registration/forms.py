...
class RegistrationForm(forms.Form):
    ...
    username = forms.RegexField(regex=r'^\w+$',
                                min_length=cafe.settings.MIN_USERNAME_LENGTH,
                                max_length=30,
                                widget=forms.TextInput(attrs=attrs_dict),
                                label=_(u'username'),
								required=cafe.settings.REGISTRATION_FIELD_TABLE['username']['required'])
    email = forms.EmailField(max_length=75,
                             widget=forms.TextInput(attrs=dict(attrs_dict,
                                                               maxlength=75)),
                             label=_(u'email address'),
                             required=cafe.settings.REGISTRATION_FIELD_TABLE['email']['required'])
    ...
    first_name = forms.RegexField(regex=r'^[\w \t]+$',
                                ...
                                required=cafe.settings.REGISTRATION_FIELD_TABLE['first_name']['required'])
    
    url = forms.URLField(max_length=1024, required=cafe.settings.REGISTRATION_FIELD_TABLE['url']['required'])

    question = forms.CharField(max_length=512, label=_(u'question'), required=cafe.settings.REGISTRATION_FIELD_TABLE['question']['required']) 

    answer = forms.CharField(max_length=512, label=_(u'answer'), required=cafe.settings.REGISTRATION_FIELD_TABLE['answer']['required']) 
